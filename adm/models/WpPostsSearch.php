...
/**
 * app\models\WpPostsSearch represents the model behind the search form about `app\models\WpPosts`.
 */
 class WpPostsSearch extends WpPosts
{
    ...
    {
        return [
            [['ID', 'post_author', 'mms_order', 'post_parent', 'menu_order', 'comment_count'], 'integer'],
