...
//	}
	...
	$ReturnString .= "<label for='user_name' id='ewd-feup-reset-password' class='ewd-feup-field-label'>Phone number:</label>";
	$ReturnString .= "<input type='text' class='ewd-feup-text-input pure-input-1-3' name='user_name' value='' />";
	$ReturnString .= "</div>";
