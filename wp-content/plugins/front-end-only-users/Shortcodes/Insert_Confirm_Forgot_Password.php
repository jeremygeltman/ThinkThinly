...
function Insert_Confirm_Forgot_Password($atts) {
	...
	$ReturnString .= "<label for='phone' id='ewd-feup-edit-password' class='ewd-feup-field-label'>Phone number: </label>";
	$ReturnString .= "<input type='text' disabled='disabled' class='ewd-feup-text-input' name='phone' class='ewd-feup-text-input pure-input-1-3' value='".$_GET['add']."' />";
	$ReturnString .= "</div>";
	$ReturnString .= "<div class='pure-control-group'>";
