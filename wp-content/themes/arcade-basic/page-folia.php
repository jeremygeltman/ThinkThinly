			...
			<div class="row">
				...
				<div class="col-sm-6 col-md-5 col-md-offset-1">
					<form action="#" novalidate="novalidate">
						...
						<input type="text" name="subscribe_phone" class="form-control" placeholder="Phone number">
    	...
    	<div class="container">
    		<div class="row">
    			...
    			<div class="col-md-4 col-sm-12 about">
	    			...
	    			<p>ThinkThinly makes loosing weight as easy as getting a text.</p>
	    			<ul class="social">
	    				<li><a href="https://www.facebook.com/thinkthinly" title="facebook"><i class="fa fa-facebook"></i></a></li>
	    				<li><a href="https://twitter.com/think_thinly" title="twitter"><i class="fa fa-twitter"></i></a></li>
	    				<li><a href="https://www.pinterest.com/thinkthinly/" title="pinterest"><i class="fa fa-pinterest"></i></a></li>
    			...
    			<div class="col-md-2 col-sm-4 col-xs-6 col-md-offset-2 col-sm-offset-0 features">
	    			<h4>Partners</h4>
	    			<ul>
	    				<li><a href="" title="sms">Weight Watchers</a></li>
